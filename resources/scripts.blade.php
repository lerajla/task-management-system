    ...
    <!-- Page level plugins -->
    <script src="{{ asset('template/start_bootstrap/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('template/start_bootstrap/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('template/start_bootstrap/js/demo/chart-pie-demo.js') }}"></script>
